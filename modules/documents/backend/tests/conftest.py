"""Fixtures for the documents module test suite.

Self-contained, like the purchase module's — a module's tests never import
another test tree, the same way its runtime never imports another module.
"""
